...
const KNOWN_SENSORS = {
  ...
  rainRate:      { label: 'Taux Pluie', unit: ' mm/h', icon: 'thunderstorm',color: 'text-indigo-400', bg: 'bg-indigo-500/10' },
};

export function getSensorMeta(key) {
  // Enlève le suffixe 'Avg', 'Min', 'Max' s'il existe pour trouver le meta de base
